...
```shell
wget https://github.com/gngpp/xunlei/releases/download/v3.8.0-19/xunlei-embed-3.8.0-19-aarch64-unknown-linux-gnu.deb

dpkg -i xunlei_3.8.0-19_amd64.deb
...
wget https://github.com/gngpp/xunlei/releases/download/v3.8.0-19/luci-app-xunlei_1.0.1-7-1_all.ipk
wget https://github.com/gngpp/xunlei/releases/download/v3.8.0-19/luci-i18n-xunlei-zh-cn_1.0.1-7-1_all.ipk

opkg install xunlei_3.8.0-19_aarch64_generic.ipk
...
### FQA
 ...
 - 指定运行库LD或压缩目前无法做到（二进制带签名），需要逆向打patch
