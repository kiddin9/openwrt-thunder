...
```shell
wget https://github.com/gngpp/nas-xunlei/releases/download/v3.5.2-10/xunlei_3.5.2-10_aarch64_generic.ipk
wget https://github.com/gngpp/nas-xunlei/releases/download/v3.5.2-10/luci-app-xunlei_1.0.1-5-1_all.ipk
wget https://github.com/gngpp/nas-xunlei/releases/download/v3.5.2-10/luci-i18n-xunlei-zh-cn_1.0.1-5-1_all.ipk

opkg install xunlei_3.5.2-10_aarch64_generic.ipk
