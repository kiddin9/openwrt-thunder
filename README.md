...
```shell
wget https://github.com/gngpp/nas-xunlei/releases/download/v3.5.2-13/xunlei-embed-3.5.2-13-aarch64-unknown-linux-gnu.deb
...
```shell
wget https://github.com/gngpp/nas-xunlei/releases/download/v3.5.2-13/xunlei_3.5.2-13_aarch64_generic.ipk
wget https://github.com/gngpp/nas-xunlei/releases/download/v3.5.2-13/luci-app-xunlei_1.0.1-5-1_all.ipk
wget https://github.com/gngpp/nas-xunlei/releases/download/v3.5.2-13/luci-i18n-xunlei-zh-cn_1.0.1-5-1_all.ipk
